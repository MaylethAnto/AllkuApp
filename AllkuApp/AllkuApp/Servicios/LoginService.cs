...
namespace AllkuApp.Servicios
{
    ...
    public class LoginService
    {
        ...
        private const string ApiUrl = "https://allkuapi-production.up.railway.app/api/Login/Login";
        ...
        {
            var response = await _httpClient.GetAsync($"https://allkuapi-production.up.railway.app/api/Login/esprimavez?username={nombreUsuario}");
